...
const ContactUs =  () => {
	...
	const formSubmitHandler = async(e) => {
		...
		const response = await axios.post('https://ecommerce-resume-default-rtdb.firebaseio.com/contact.json', obj);
	...
	return (
		<div>
			...
			<div className="flex flex-col justify-center text-center mt-3 text-2xl p-3 ">
				<div className="p-3">
					<h1>Contact</h1>
					<p className="font-thin">sanketrahangdale1118@gmail.com</p>
				</div>
				<div className="p-3">
					<h1>Based in</h1>
					<p className="font-thin">Balaghat,</p>
					<p className="font-thin">MadhyaPradesh</p>
				</div>
				<div>
				</div>
			</div>
