    ...
    const AuthHandler = async (obj) => {
        try {
            if (login) {
                ...
                setSendingReq(true);
                const response = await axios.post(`https://ecommerce-resume-default-rtdb.firebaseio.com/login.json`, obj);
                setSendingReq(false);
                ...
                setSendingReq(true);
                const response = await axios.post(`https://ecommerce-resume-default-rtdb.firebaseio.com/signup.json`, obj);
                setAlertSeverity('success');
                setAlertMsg(response.data.msg);
                setSendingReq(false);
                setLogin(true);
